...
**Відомі обмеження:**
- Виправлено в OCA 3.0.5 ~~Діалоги відкриття/збереження в деяких застосунках працюють не повністю, оскільки є реалізація нової функції в Windows Vista, так званої IFileDialog. Робота триває;~~
...
- Починаючи з версії OCA 3.0.5, додатки, які були під х86, тепер працюють на Windows XP/Server 2003 x64 ~~Firefox починаючи з версії 54 (32 біт) не працює на Windows XP x64. Chrome 61+ також не працює;~~
