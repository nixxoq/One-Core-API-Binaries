...
- JetBrains WebStorm up to 2020.x
- JetBrains IntelliJ up to 2020.x
- Adobe Photoshop CC 2018;
- Filezilla (latest);
- Discord 0.309.0
- Visual Studio Code up to 1.84.1 (unofficial x86 version);
- Chrome up to version 128;
- Opera up to version 109;
- Firefox up to version 128 (with some bugs);
- Microsoft Edge up to version 122;
- Brave up to version 1.62.153 (Chromium 121);
- Yandex Browser latest version;
- Thorium browser up to 122;
...
- Epic Browser 120;
- Python 3.11 (with connection problems to pypi);
- .Net Framework up to 4.8;
- Geekbench 4.2;
- Performance Test;
- Adobe Reader DC (2018, 2021 works with some bugs);
- Windows 7 Applications (Paint, Games, Wordpad)
...
- Firefox 55-128 working with some limitations;
- The packages cannot be integrate with nlite to the Windows iso, because the One-Core-API uses a tool called "SFXCAB Substitute", not a standard Microsoft version;
